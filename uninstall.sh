...
rm -f "$PREFIX/bin/xcind-prompt"
rm -f "$PREFIX/bin/xcind-proxy"
rm -f "$PREFIX/bin/xcind-run"
...
rm -f "$PREFIX/lib/xcind/xcind-run-lib.bash"
...
rm -f "$PREFIX/lib/xcind/xcind-discovery-lib.bash"
rm -f "$PREFIX/lib/xcind/xcind-hostenv-lib.bash"
