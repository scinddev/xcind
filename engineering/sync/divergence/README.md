...
| [0028](./0028-workspace-orchestration-up-down.md) | Workspace-wide up/down/restart | Scope | **Resolved** (R4: Xcind converged via `up`/`down`, `12737f8`; R5: full surface incl. `restart`/`-a`/`--volumes`, #90/#91) | SA-0013 |
...
| [0038](./0038-app-side-workspace-self-declaration.md) | Application-side workspace self-declaration | Design | Active | XA-0022 / L-0037 |
